...
module HStratus.ApiLoggerSpec (spec) where

import Data.Aeson (Value, decode)
import qualified Data.ByteString.Char8 as BS8
import qualified Data.ByteString.Lazy.Char8 as LBS8
import Data.List (isPrefixOf)
import HStratus.Mock (defaultScenario, withMockApp)
import Network.HStratus.Http (ApiLogger, fileLogger, login, mkApiWith, redactingLogger, withLogger)
...
spec :: Spec
spec = describe "Network.HStratus.Http.fileLogger" $ do
