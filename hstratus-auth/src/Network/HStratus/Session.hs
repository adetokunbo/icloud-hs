...
credentials file is read from @$XDG_CONFIG_HOME\/hs-hstratus-auth\/credentials.json@;
...
module Network.HStratus.Session
  ( -- * Credentials
    ...
    @$XDG_CONFIG_HOME\/hs-hstratus-auth\/credentials.json@ with the fields
  ...
  , AccountData (..)
    ...
    @$XDG_CONFIG_HOME\/hs-hstratus-auth\/credentials.json@ and initialises the
  ...
  , loadSession
    ...
    {- | Write 'Credentials' to @$XDG_CONFIG_HOME\/hs-hstratus-auth\/credentials.json@,
